...
with DAG(
    ...
    dbt_run = BashOperator(
        ...
        bash_command=f"dbt deps --project-dir {DBT_DIR} --profiles-dir {DBT_PROFILES_DIR} && dbt run --project-dir {DBT_DIR} --profiles-dir {DBT_PROFILES_DIR} --log-path /tmp/dbt_logs --target-path /tmp/dbt_target"
    )
