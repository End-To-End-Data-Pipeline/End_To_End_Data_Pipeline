...
parser.add_argument("--dlq-topic", default=os.getenv("DLQ_TOPIC", "dlq_messages"),help="Kafka topic for dead letter queue (failed messages)")
                ...
                for msg in messages:
                    try:
                        ...
                        error_header = [
                            ...
                            ('original_topic', tp.topic.encode('utf-8'))
                        ]
